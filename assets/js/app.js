...
const sttaddr = "0x6db6f77cfb55045f72c48ac1f71e3567fcaae39b";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x6db6f77cfb55045f72c48ac1f71e3567fcaae39b";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+30 BDEFI sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://babydefi.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x6db6f77cfb55045f72c48ac1f71e3567fcaae39b',
                    'symbol': 'BDEFI',
                    'decimals': '8',
                    'image': 'https://babydefi.net/wp-content/uploads/logo.png',
                },
            },
